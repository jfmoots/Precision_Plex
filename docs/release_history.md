...
- Updates awning-light, water-pump, water-heater, awning, and all slide control
  states immediately while PID32 confirmation is pending.
- Keeps matching cover and binary-sensor states synchronized.
- Reconciles on PID32/02BB confirmation and safely falls back after 12 seconds.
- Retains the independent 30-second LIN source freshness grace periods.
