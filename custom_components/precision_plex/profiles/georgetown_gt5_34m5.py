"""Georgetown GT5 34M5 coach profile.

This profile contains the mappings that were hardcoded in Precision Plex v4.0.3.
Keeping them here preserves the existing behavior while making future coach
profiles possible.
"""
...
GENERATOR_AUTO_START_PRESS = bytes.fromhex(
    "55 1D 10 0B 00 3E 0A 00 00 00 00 00 00 00 00 2B"
)
GENERATOR_AUTO_STOP_PRESS = bytes.fromhex(
...
PROFILE = {
    "id": "georgetown_gt5_34m5",
    "name": "Georgetown GT5 34M5",
    "manufacturer": "Forest River",
    "platform": "Precision Plex Wireless TP Monitor",
    "state_bits": STATE_BITS,
    "command_payloads": COMMAND_PAYLOADS,
    "awning_light_tap_sequence": AWNING_LIGHT_TAP_SEQUENCE,
    "water_pump_tap": WATER_PUMP_TAP,
    "water_heater_tap": WATER_HEATER_TAP,
    "generator_start_sequence": GENERATOR_START_SEQUENCE,
    "generator_stop_sequence": GENERATOR_STOP_SEQUENCE,
    "generator_auto_start_sequence": GENERATOR_AUTO_START_SEQUENCE,
    "generator_auto_stop_sequence": GENERATOR_AUTO_STOP_SEQUENCE,
}
