    ...
    diagnostics: dict[str, Any] = {
        ...
        "coordinator": {
            ...
            "generator": {
                ...
                "preferred_running": getattr(coordinator, "generator_running_value", None),
                "status": getattr(coordinator, "generator_status", None),
                "preferred_status": getattr(coordinator, "generator_status_value", None),
                "status_key": getattr(coordinator, "generator_status_key", None),
                "runtime_hours": getattr(coordinator, "generator_runtime_hours", None),
                "preferred_runtime_hours": getattr(coordinator, "generator_runtime_hours_value", None),
                "runtime_source": getattr(coordinator, "generator_runtime_source", None),
                "command_pending": getattr(coordinator, "generator_command_pending_status", None),
